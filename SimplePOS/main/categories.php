...
<body>
  ...
  <section id="content">
    ...
    <main>
          ...
          <div class="col-12 my-2">
            <div class="row my-2">
              ...
              <div class="col-sm-auto col-form-label">
                <button class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#modaladdcategory"><i class='bx bx-add-to-queue' style="font-size: 16px ;"></i> Add</button>
              </div>
            </div>
          </div>
          <hr>
            ...
            ?>
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $row['category_no_items']; ?></td>
                    <td>
                      <a class="editbtn"><i class="bx bx-pencil icon"></i> </a>
                      <input type="hidden" class="delete_id_value" value="<?php echo $row['category_id']; ?>">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="header">Add Categories</h5>
            ...
            <form action="insertcode.php" method="POST">
              ...
              <div class="modal-body">
                <div class="container">
                  ...
                  <div class="form-group row mb-2">
                    ...
                    <input class="col-sm-7 pos-input" type="text" name="category_name" required>
                  </div>

                  <div class="form-group row mb-2">
                    <div class="col-sm-5 col-form-label">No. of Items:</div>
                    <input class="col-sm-7 pos-input" type="number" name="category_no_items" required>
                  </div>
                </div>
              </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" name="insertcategory" class="btn btn-success">Save</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <!-- EDIT -->
      <div class="modal fade" id="modaleditcategory" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">

        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="header">Edit Category</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="updatecode.php" method="POST">
              <div class="modal-body">
                <div class="container">
                  ...
                  <div class="form-group row mb-2">
                    <div class="col-sm-5 col-form-label">Name:</div>
                    <input class="col-sm-7 pos-input" type="text" name="category_name" id="category_name">
                  </div>

                  <div class="form-group row mb-2">
                    <div class="col-sm-5 col-form-label">No. of Items:</div>
                    <input class="col-sm-7 pos-input" type="number" name="category_no_items" id="category_no_items">
                  </div>
                </div>
              </div>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" name="category_updatedata" class="btn btn-success">Save</button>
              </div>
            </form>
          </div>
        </div>
  ...
  <script>
    $(document).ready(function() {
      $('.editbtn').on('click', function() {
        ...
        $('#category_update_id').val(data[0]);
        $('#category_name').val(data[1]);
        $('#category_no_items').val(data[2]);
